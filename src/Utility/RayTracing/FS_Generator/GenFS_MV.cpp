...
void GenFS_MV::Visit(const Lambertian::CPtr & lambertian) {
...
void GenFS_MV::Visit(const Metal::CPtr & metal) {
...
void GenFS_MV::Visit(const Dielectric::CPtr & dielectric) {
...
void GenFS_MV::Accept(const GenFS_TV::Ptr & genFS_TV) {
