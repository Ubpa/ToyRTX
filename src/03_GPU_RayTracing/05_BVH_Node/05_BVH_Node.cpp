...
int main(int argc, char ** argv) {
	...
	printf("\n"); 
	*/
	CppUtil::OpenGL::Texture sceneDataTex(genData.GetSceneData().size(), 1, genData.GetSceneData().data(), GL_FLOAT, GL_RED, GL_R32F);
	CppUtil::OpenGL::Texture matDataTex(genData.GetMatData().size(), 1, genData.GetMatData().data(), GL_FLOAT, GL_RED, GL_R32F);
	CppUtil::OpenGL::Texture texDataTex(genData.GetTexData().size(), 1, genData.GetTexData().data(), GL_FLOAT, GL_RED, GL_R32F);
